...
<meta property="dcterms.issued" content="2016-02-19T11:59:14-0500" />
...
<p>With some of the shortest wait times in the province and expert surgeons, we're focused on patient safety and quality so that you know you're in good hands.&nbsp; <a title="view our surgery page" href="/en/ourservices/surgery.asp">Learn more</a>.</p></div></div></div><div class="banner">
                        <div class="bannerImage">
...
<p>We're looking for people interested in giving us honest feedback and advice as a Patient and Family Experience Advisor at Lakeridge Health...<a title="View our Patient and Family Advisors page" href="/en/howyoucanhelp/Patient-and-Family-Advisors-.asp">Learn More.</a></p></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="bucketContainers">
                        ...
                        <div id="contentLeft" class="homepageBucket">
                            ...
                            <div class="homepageBucketContent bucketContent">
                                <!--Optional Token-->
                                <h3><a title="Open file in new window: Infographic_-_When_to_Visit_the_ER_3.pdf" href="/en/resourcesGeneral/Homepage/Infographic_-_When_to_Visit_the_ER_3.pdf" target="_blank"><img title="WHEN should I go to the ER?" src="/en/resourcesGeneral/Homepage/ER_6.jpg" alt="WHEN should I go to the ER?" /></a></h3>
<p>&nbsp;</p>
                            </div>   
                        </div>
                        <!--googleoff: all-->
...
<p>&nbsp;</p>
                            ...
                            <div class="homepageBucketContent bucketContent">
                                <!--Optional Token--> 
                                <h3><a name="knitarow"></a><a title="View our Treatment page" href="/en/ourservices/treatment.asp"><img title="View our Knit a Row video " src="/en/resources/KnitaRow_hands_playbutton.jpg" alt="Knit a Row" width="310" height="147" /></a></h3>
                            </div>   
                        </div>
                        <!--googleoff: all-->
                        ...
                        <div id="contentRight" class="homepageBucket">
                            <div class="homepageBucketContent">
                                <!--Token-->
                                <p><a title="Open new window to view https://www.lakeridgehealth.on.ca/en/news/index.aspx?_mid_=2095&amp;amp;newsId=0bbd779d-7491-4867-839c-d2b1e7c9d0c3" href="https://www.lakeridgehealth.on.ca/en/news/index.aspx?_mid_=2095&amp;newsId=0bbd779d-7491-4867-839c-d2b1e7c9d0c3"><img title="Greater Toronto's Top Employers 2016" src="/en/resourcesGeneral/Homepage/GTA-edit.jpg" alt="Greater Toronto's Top Employers 2016" /></a></p>
                            </div>     
                            <div class="homepageBucketContent bucketContent">
                                 <!--Optional Token-->
