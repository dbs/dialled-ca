...
ddsmoothmenu.init({
	...
	customtheme: ["#000000", "#72A392"], //override default menu CSS background values? Uncomment: ["normal_background", "hover_background"]
	contentsource: ["menucontainer", "menu.html"] //"markup" or ["container_id", "path_to_menu_file"]
})
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-26254998-12']);
...
slideimages[0]='<img src="images/hdrHome01.jpg">'
slideimages[1]='<img src="images/hdrHome02.jpg">'
slideimages[2]='<img src="images/hdrHome03.jpg">'
slideimages[3]='<img src="images/hdrHome04.jpg">'
//extend this list
...
document.writeln('</div>')
      ...
      <table width="972" border="0" align="center" cellpadding="0" cellspacing="0" id="body">
        <tr>
          ...
          <td width="540" align="left" valign="top"><table width="540" border="0" align="left" cellpadding="0" cellspacing="0">
            
            <tr>
              <td width="520" align="left" valign="top"><!-- InstanceBeginEditable name="PageContent" -->
                <p class="BlackBold18pt">Error 404 - Not Found<br />
                </p>
                <p>The requested web page cannot be found.</p>
                <p>The requested web page may be temporarily unavailable (in which case, you can try again later) or it is possible that the requested web page has been deleted.</p>
                <p>We are sorry for any inconvenience this may have caused you.</p>
                <p>Return to theÂ <a href="../index.html">home page</a>.                </p>
                <p class="Black12pt">&nbsp;</p>
              <!-- InstanceEndEditable --></td>
              <td width="20" rowspan="2">&nbsp;</td>
            </tr>
            <tr>
              <td width="520" height="20" align="left" valign="top">&nbsp;</td>
            </tr>
          </table>          </td>
          <td width="218" align="left" valign="top" bgcolor="#FFFFFF"><table width="218" border="0" cellpadding="0" cellspacing="0" id="navMain" bgcolor="#FFFFFF">
              <tr>
                <td align="left" valign="top">&nbsp;</td>
              </tr>
              <tr>
              <td align="left" valign="top"><form action="http://search.winnipeghealthregion.ca/search" method="get" name="gs" id="gs">
                <table width="216" border="0" align="center" cellpadding="0" cellspacing="0" id="search">
                  <tr valign="top">
                    <td align="right" valign="top"><input name="q" type="text" class="Black12pt" value="" size="24" maxlength="256" /></td>
                    <td width="50" align="right" valign="top"><input name="btnG" type="image" class="sitetext" value="Go" src="http://www.deerlodge.mb.ca/images/btSearch.jpg" width="50" height="20" align="middle" />
                      <input type="hidden" name="entqr" value="0" />
                      <input type="hidden" name="output" value="xml_no_dtd" />
                      <input type="hidden" name="sort" value="date:D:L:d1" />
                      <input type="hidden" name="ud" value="1" />
                      <input type="hidden" name="client" value="dlc_internet" />
                      <input type="hidden" name="oe" value="UTF-8" />
                      <input type="hidden" name="ie" value="UTF-8" />
                      <input type="hidden" name="proxystylesheet" value="dlc_internet" />
                      <input type="hidden" name="site" value="dlc_collection" />
                      <input type="hidden" name="filter" value="0"/></td>
                  </tr>
                </table>
              </form></td>
            </tr>
          ...
          <td width="107" align="left" valign="bottom">
          </td>
        </tr>
      </table>      
            ...
            <tr>
              <td height="30" colspan="3" align="left" valign="bottom" class="Grey11pt"><table width="720" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="712" align="left" valign="bottom" class="Grey10pt">&copy; 2002
...
<!-- Google Analytics attachment coding -->
...
<script>
  ...
  $("a[href$='ppt']").each(function(index) {
    ...
    pptOnClick = "_gaq.push(['_trackEvent', 'PPT', 'Download', '" + pptLabel + "']);";
    $(this).attr("onClick", pptOnClick);
  });
  $("a[href$='docx']").each(function(index) {
    docxLabel = $(this).attr('href');
    docxOnClick = "_gaq.push(['_trackEvent', 'DOCX', 'Download', '" + docxLabel + "']);";
    $(this).attr("onClick", docxOnClick);
  });
  $("a[href$='xlsx']").each(function(index) {
    xlsxLabel = $(this).attr('href');
    xlsxOnClick = "_gaq.push(['_trackEvent', 'XLSX', 'Download', '" + xlsxLabel + "']);";
    $(this).attr("onClick", xlsOnClick);
  });
  $("a[href$='pptx']").each(function(index) {
    pptxLabel = $(this).attr('href');
    pptxOnClick = "_gaq.push(['_trackEvent', 'PPTX', 'Download', '" + pptxLabel + "']);";
