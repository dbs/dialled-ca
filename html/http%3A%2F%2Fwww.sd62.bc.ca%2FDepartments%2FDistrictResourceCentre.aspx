...
<head>
    ...
    <title>Page not found | Sooke School District</title>
    <meta name="author" content="Baby Kids">
    <meta name="viewport" content="width=device-width, initial-scale=1.0"> <!--meta responsive-->
    
    <!--[if lt IE 9]>
	<script src="http://www.sd62.bc.ca/wp-content/themes/babykids/js/main/html5.js"></script>
	<![endif]-->

        
    
    <!--CUSTOM FAVICONS-->
    <link rel="shortcut icon" href="http://districtwebsite.web.sd62.bc.ca/wp-content/uploads/sites/11/2015/11/logo16.png">
    <link rel="apple-touch-icon" href="http://districtwebsite.web.sd62.bc.ca/wp-content/uploads/sites/11/2015/11/logo57.png">
    <link rel="apple-touch-icon" sizes="72x72" href="http://districtwebsite.web.sd62.bc.ca/wp-content/uploads/sites/11/2015/11/logo72.png">
    <link rel="apple-touch-icon" sizes="114x114" href="http://districtwebsite.web.sd62.bc.ca/wp-content/uploads/sites/11/2015/11/logo114.png">
    <!--END CUSTOM FAVICONS-->
...
color: ;
			...
			jQuery(document).ready(function() {
				...
				var ajaxRevslider = function(obj) {
					...
					jQuery.ajax({
						type:"post",
						url:"http://www.sd62.bc.ca/wp-admin/admin-ajax.php",
						dataType: 'json',
						data:data,
						async:false,
    ...
    <style type="text/css">
        ...
        #wp-calendar caption, .widget_calendar > h2 { background-color: #1e73be; }
        .widget_categories > h2 { background-color: #edbf47; }
        .widget_nav_menu > h2 { background-color: #1e73be; }
        .widget_meta > h2 { background-color: #1e73be; }
        .widget_pages > h2 { background-color: #edbf47; }
        .widget_recent_comments > h2 { background-color: #edbf47; }
        .widget_recent_entries > h2 { background-color: #edbf47; }
        .widget_slider > h2 { background-color: #edbf47; }
        .widget_rss > h2 { background-color: #edbf47; }
        .widget_search > h2 { background-color: #1e73be; }
        .widget_text > h2 { background-color: #1e73be; }
        .widget_tag_cloud > h2 { background-color: #edbf47; }
        .tt_upcoming_events_widget > h2 { background-color: #1e73be; }
        ...
        /****************************************START GREEN******************************************************/
/*first*/
.nicdark_bg_green{ background-color: #23876c; }
p.green,h1.green,h2.green,h3.green,h4.green,h5.green,h6.green,a.green,i.green,span.green, input[type="text"].green, textarea.green, input[type="submit"].green, select.green{ color:#23876c; }
.nicdark_bg_green_hover:hover{ background-color: #23876c !important; }
/*second*/
.nicdark_border_green, .nicdark_border_green td, .nicdark_border_green th{ border: 2px solid #23876c; }
.nicdark_shadow.nicdark_bg_green{ box-shadow: 0px 4px 0px 0px #23876c; }
.nicdark_bg_greendark{ background-color: #23876c; }
.nicdark_iconbg.green{ color: #23876c; }
.nicdark_triangle.green{ border-color: #23876c transparent transparent transparent; }
.nicdark_bg_greendark_hover:hover{ background-color: #23876c !important; }
/*third*/
...
/****************************************START VIOLET******************************************************/
/*first*/
.nicdark_bg_violet{ background-color: #97acd7; }
.nicdark_bg_violet_hover:hover { background-color: #97acd7 !important; }
p.violet,h1.violet,h2.violet,h3.violet,h4.violet,h5.violet,h6.violet,a.violet,i.violet,span.violet, input[type="text"].violet, textarea.violet, input[type="submit"].violet, select.violet{ color:#97acd7; }
/*second*/
.nicdark_bg_violetdark{ background-color: #97acd7; }
.nicdark_border_violet, .nicdark_border_violet td, .nicdark_border_violet th{ border: 2px solid #97acd7; }
.nicdark_shadow.nicdark_bg_violet{ box-shadow: 0px 4px 0px 0px #97acd7; }
.nicdark_iconbg.violet{ color: #97acd7; }
.nicdark_triangle.violet{ border-color: #97acd7 transparent transparent transparent;}
.nicdark_bg_violetdark_hover:hover{ background-color: #97acd7 !important; }
/*third*/
...
/****************************************START ORANGE******************************************************/
/*first*/
.nicdark_bg_orange{ background-color: #124f8c; }
.nicdark_bg_orange_hover:hover{ background-color: #124f8c !important; }
p.orange,h1.orange,h2.orange,h3.orange,h4.orange,h5.orange,h6.orange,a.orange,i.orange,span.orange, input[type="text"].orange, textarea.orange, input[type="submit"].orange, select.orange{ color:#124f8c; }
/*second*/
.nicdark_bg_orangedark{ background-color: #124f8c; }
.nicdark_bg_orangedark_hover:hover{ background-color: #124f8c !important; }
.nicdark_border_orange, .nicdark_border_orange td, .nicdark_border_orange th{ border: 2px solid #124f8c; }
.nicdark_shadow.nicdark_bg_orange{ box-shadow: 0px 4px 0px 0px #124f8c; }
.nicdark_iconbg.orange{ color: #124f8c; }
.nicdark_triangle.orange { border-color: #124f8c transparent transparent transparent;  }
/*third*/
...
/****************************************START RED******************************************************/
/*first*/
.nicdark_bg_red{ background-color: #ffffff; }
.nicdark_bg_red_hover:hover{ background-color: #ffffff !important; }
p.red,h1.red,h2.red,h3.red,h4.red,h5.red,h6.red,a.red,i.red,span.red, input[type="text"].red, textarea.red, input[type="submit"].red, select.red{ color:#ffffff; }
/*second*/
.nicdark_bg_reddark{ background-color: #bababa; }
.nicdark_border_red, .nicdark_border_red td, .nicdark_border_red th{ border: 2px solid #bababa; }
.nicdark_shadow.nicdark_bg_red{ box-shadow: 0px 4px 0px 0px #bababa; }
.nicdark_iconbg.red{ color: #bababa; }
.nicdark_triangle.red{ border-color: #bababa transparent transparent transparent; }
.nicdark_bg_reddark_hover:hover{ background-color: #bababa !important; }
/*third*/
...
/****************************************START YELLOW******************************************************/
/*first*/
.nicdark_bg_yellow{ background-color: #1e73be; }
.nicdark_bg_yellow_hover:hover{ background-color: #1e73be !important; }
p.yellow,h1.yellow,h2.yellow,h3.yellow,h4.yellow,h5.yellow,h6.yellow,a.yellow,i.yellow,span.yellow, input[type="text"].yellow, textarea.yellow, input[type="submit"].yellow, select.yellow{ color:#1e73be; }
/*second*/
.nicdark_bg_yellowdark{ background-color: #1e73be; }
.nicdark_border_yellow, .nicdark_border_yellow td, .nicdark_border_yellow th{ border: 2px solid #1e73be; }
.nicdark_shadow.nicdark_bg_yellow{ box-shadow: 0px 4px 0px 0px #1e73be; }
.nicdark_iconbg.yellow{ color: #1e73be; }
.nicdark_triangle.yellow{ border-color: #1e73be transparent transparent transparent; }
.nicdark_bg_yellowdark_hover:hover{ background-color: #1e73be !important; }
/*third*/
...
.menu  > .yellow > a:after, .menu  > .yellow .sub-menu li:first-child:before, .menu  > .yellow .sub-menu li ul li:first-child:before{ color: #1e73be; }
...
.nicdark_bg_yellow .tinynav { color: #fff; background-color: #1e73be; box-shadow: 0px 4px 0px 0px #d4ae49; }
...
/****************************************START ELEMENTS******************************************************/
/*button search*/
.widget_search input[type="submit"]{ background-color: #124f8c; }
.widget_search input[type="submit"]{ box-shadow: 0px 4px 0px 0px #124f8c; }
/*post elements*/
.comment-respond input[type="submit"]{ box-shadow: 0px 4px 0px 0px #124f8c; background-color: #124f8c; }
.comment-reply-link{ box-shadow: 0px 4px 0px 0px #124f8c; background-color: #124f8c; }
/*calendar*/
.ui-datepicker-calendar thead{ background-color: #23876c; }
.ui-datepicker-today a { background-color: #23876c;}
.ui-datepicker-calendar .ui-state-hover{ background-color: #23876c; }
/*slider*/
.ui-slider .ui-slider-handle { background-color: #1e73be; }
.ui-slider .ui-slider-range { background-color: #1e73be; }
/*cf7*/
div.wpcf7-validation-errors, div.wpcf7-mail-sent-ng, div.wpcf7-spam-blocked { box-shadow: 0px 4px 0px 0px #124f8c; background-color: #124f8c; }
div.wpcf7-mail-sent-ok { box-shadow: 0px 4px 0px 0px #23876c; background-color: #23876c; }
.wpcf7-not-valid-tip:before{ color: #bababa; }
.wpcf7-not-valid-tip{ background-color: #ffffff; box-shadow: 0px 4px 0px 0px #bababa; }
/****************************************END ELEMENTS******************************************************/
...
.wc-backward { background-color: #ffffff; box-shadow: 0px 4px 0px 0px #bababa; }
.shop_table .actions .checkout-button { background-color: #ffffff !important; box-shadow: 0px 4px 0px 0px #bababa; }
.woocommerce table.cart a.remove,
.woocommerce-page table.cart a.remove,
.woocommerce #content table.cart a.remove,
.woocommerce-page #content table.cart a.remove { background-color:#ffffff; }
.woocommerce table.cart a.remove:hover,
.woocommerce-page table.cart a.remove:hover,
.woocommerce #content table.cart a.remove:hover,
.woocommerce-page #content table.cart a.remove:hover { background-color:#bababa; }

/*orange*/
.shop_table .actions .button { background-color: #124f8c !important; box-shadow: 0px 4px 0px 0px #124f8c; }
.woocommerce table.shop_table th,
.woocommerce-page table.shop_table th { background: #124f8c; }

/*yellow*/
.products li .star-rating,
.woocommerce .widget_price_filter .button { background-color: #1e73be;box-shadow: 0px 4px 0px 0px #1e73be; }
...
p.stars a.star-5:after { color: #1e73be; }
.shop_table .actions .coupon .button { background-color: #1e73be !important; box-shadow: 0px 4px 0px 0px #1e73be; }
.woocommerce .widget_price_filter .ui-slider .ui-slider-handle,
.woocommerce-page .widget_price_filter .ui-slider .ui-slider-handle { border:1px solid #1e73be; background:#1e73be; }
.woocommerce .widget_price_filter .ui-slider .ui-slider-range,
.woocommerce-page .widget_price_filter .ui-slider .ui-slider-range { background:#1e73be; }
...
.widget.widget_shopping_cart .widget_shopping_cart_content p.buttons a.checkout { background-color:#23876c; box-shadow: 0px 4px 0px 0px #23876c; }
.woocommerce .comment-respond input[type="submit"] { background: #23876c !important; box-shadow: 0px 4px 0px 0px #23876c; }
.woocommerce button,
.woocommerce input[type=submit],
p.stars a:hover,
p.stars a.active { background: #23876c !important; box-shadow: 0px 4px 0px 0px #23876c;}
...
.product .related h2:after { background-color: #23876c; }
.entry-summary div .price ins { color: #23876c; }
...
{ font-family: Montez; }        /*end color and font settings*/
        ...
        body{
            background-color: #ffffff !important;            background-image:  !important;            background-repeat:  !important;            background-position:  !important;            background-size:  !important;            background-attachment:  !important;        } 
...
<body id="start_nicdark_framework" class="error404 wpb-js-composer js-comp-ver-4.3.5 vc_responsive">
...
<div class="nicdark_section nicdark_bg_greydark nicdark_displaynone_responsive">
  ...
  <span class="grey nicdark_marginright10 nicdark_marginleft10">·</span>
    <a class="white title" href="/staff/">STAFF</a>
    <span class="grey nicdark_marginright10 nicdark_marginleft10">·</span>
    <a class="white title" href="https://go.sd62.bc.ca/">SHAREPOINT</a>
</h6>            </div>
        </div>
        <div class="grid grid_6 right">
            <div class="nicdark_focus right">
                                <h6 class="white">
    <a class="white title" href="/schools/calendar/">CALENDARS</a>
    <span class="grey nicdark_marginright10 nicdark_marginleft10">·</span>
   <a class="white title" href="/careers/">CAREERS</a>
   <span class="grey nicdark_marginright10 nicdark_marginleft10">·</span>
 <a class="white title" href="/contactus/">CONTACT US</a>
</h6>  
            </div>
        </div>
...
<!--end before navigation-->
		    ...
		    <!--decide gradient or not-->
		        ...
		        <!--start header-->
<div class="nicdark_bg_red nicdark_section nicdark_shadow nicdark_radius_bottom fade-down">
    ...
    <div class="nicdark_container nicdark_clearfix">
        <div class="grid grid_12">
            ...
            <div class="nicdark_alerts nicdark_bg_yellow nicdark_radius nicdark_shadow">
                <p class="white nicdark_size_big"><i class="icon-cancel-circled-outline iconclose"></i>&nbsp;&nbsp;&nbsp;<strong>404:</strong>&nbsp;&nbsp;&nbsp;Oops 404, That page can not be found</p>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_4 nomargin percentage">
            ...
            <div class="nicdark_margin10">
                <div id="text-4" class="widget widget_text"><h2>Sooke School District</h2>			<div class="textwidget"><p>3143 Jacklin Road, Victoria, BC   V9B 5R1 </p>
<p>Phone: (250) 474-9800<br />
Email: <a href=mailto:info@sd62.bc.ca style="color:#2e445a">info@sd62.bc.ca</a></p>
<p>Hours:  8:30 a.m. - 4 p.m. Monday - Friday </p>
</div>
		</div>            </div>
        </div>
        ...
        <div class="grid grid_4 nomargin percentage">
            ...
            <div class="nicdark_margin10">
                <div id="search-3" class="widget widget_search"><h2>Can&#8217;t find what you&#8217;re looking for?</h2><form role="search" method="get" id="searchform" class="searchform" action="http://www.sd62.bc.ca/">
				<div>
        ...
        <div class="grid grid_4 nomargin percentage">
            ...
            <div class="nicdark_margin10">
                <div id="text-7" class="widget widget_text">			<div class="textwidget"><div style="margin-top:-20px">
<a class=" nicdark_btn nicdark_bg_orange medium   nicdark_shadow  nicdark_radius white" title="" href="/contactus" target=" style=">Contact Us</a>
</div>
</div>
		</div><div id="text-5" class="widget widget_text">			<div class="textwidget"><div style="margin-top:-20px">
<a class=" nicdark_btn nicdark_bg_orange medium   nicdark_shadow  nicdark_radius white" title="" href="/schools/calendar" target=" style=">Calendars</a>
</div></div>
		</div><div id="text-6" class="widget widget_text">			<div class="textwidget"><div style="margin-top:-20px">
<a class=" nicdark_btn nicdark_bg_orange medium   nicdark_shadow  nicdark_radius white" title="" href="/careers" target=" style=">Careers</a>
</div></div>
		</div>            </div>
        </div>
...
<div style="margin:0px 30px;font-size:24;float:left">
<a href="http://districtwebsite.web.sd62.bc.ca/staff/" target="_self" style="color:white">Staff</a>
</div>

<div style="margin:0px 30px;font-size:24;float:left">
<a href="https://go.sd62.bc.ca/" target="_self" style="color:white">Sharepoint</a>
</div>
<div style="margin:0px 30px;font-size:24;float:left">
<a href="https://exchange.sd62.bc.ca/owa/auth/logon.aspx?replaceCurrent=1&amp;url=https%3a%2f%2fexchange.sd62.bc.ca%2fowa%2f" target="_self" style="color:white">Outlook Mail</a>
</div>
</div>
        </div>
        ...
        <div class="grid grid_6">
            <div class="nicdark_focus right nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
                                ...
                                <div class="nicdark_margin10">
    <a href="https://twitter.com/SD62_Sooke" target="_blank" class="nicdark_press right nicdark_btn_icon nicdark_shadow small nicdark_radius white"><i class="icon-twitter-1"></i></a>
</div>
<div class="nicdark_margin10">
    <a href="https://www.facebook.com/SchoolDistrict62/" target="_blank" class="nicdark_press right nicdark_btn_icon nicdark_shadow small nicdark_radius white"><i class="icon-facebook-1"></i></a>
</div>
                <!--back to top-->
